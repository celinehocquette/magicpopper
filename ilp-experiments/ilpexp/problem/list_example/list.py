...
class ListExample(Problem):
    ...
    def __init__(self, num_train_examples, num_test_examples=NUM_TEST_EXAMPLES):
        super().__init__("list_example", parameter=num_train_examples)
